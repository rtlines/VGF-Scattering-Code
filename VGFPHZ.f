...
C****    expressed in the body frame cordinates as well. Thus, the     *
C****    subroutine Rot from VGFMC is employed to do the               *
C****    transformations. Like VGFMC the assumed time dependence is    *
C****    given by the expression exp(ikr-iwt).  The program takes as   *
C****    its input the output files from VGFMC containing the          *
C****    electric fields.                                              *
C****                                                                  *
C**** Geometry:                                                        *
...
C****   field calculation (performed by the program VGFMC)             *
...
C****   NY, 1970). These angles are passed on to VGFPHZ for use in its *
